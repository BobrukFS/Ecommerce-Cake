...
function About() {
  return (
    ...
    <div className="about container-fluid p-md-4 p-lg-5 ">
        ...
        <div className='about__main  row d-flex '>
          <div className=' justify-content-center col-md-5 d-flex gap-4'>
            ...
            <div className='col-md-5 py-1 mb-5 '>
                ...
                <p className='paragraph-font my-2 fs-6'>En Tiempo de Fantasia, nos especializamos en ofrecer manualidades personalizadas para una amplia variedad de eventos.</p>
                <p className='paragraph-font fs-6 mb-4'>Ya sea un cumpleaños, un bautismo, un casamiento o comunion, nos esforzamos por crear piezas unicas y significativas que se adapten perfectamente a cada ocasion. Nos complace ser parte de tus momentos mas especiales y convertirlos en recuerdos eternos.</p>
