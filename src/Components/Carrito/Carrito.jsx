...
export const Carrito = () => {
  ...
  const realizarPago = () =>{
    Swal.fire({
      title: "Se realizo su compra",
      text: "Recibira su ticket via mail, muchas gracias!",
      icon: "success"
    });
  }

  return (
    <main className={`checkout theme-change row ${theme === 'light' ? 'bg-white' : 'bg-secondary'} `}>
      <div className=" col-12 col-lg-6 px-4 px-sm-5 ">
        <h2 className={`${theme === 'light' ? 'text-secondary' : 'text-white'} titles-font fs-1 fw-bold border-bottom border-primary pb-1 w-100`}>
          Carrito de compras
        </h2>
              ...
              >
                <td className="d-flex carrito-td align-items-center justify-content-between gap-2 gap-lg-4 w-100">
                  <img
                    ...
                    alt={`${e.titulo}`}
                  />
                  <p className={`${theme === 'light' ? 'text-secondary' : 'text-white'} fw-bold paragraph-font mb-0 paragraph-font text-secondary fs-sm-5`}>{e.titulo}</p>
      ...
      <div className="metodo-pagos d-flex flex-column align-items-start col-12 col-lg-6 px-3 px-sm-5 my-5 m-lg-0  ">
        <div className="d-flex flex-column container-fluid ">
          ...
          <button className="d-flex align-items-center  justify-content-center  gap-2 bg-info border-0 rounded-3  text-white fs-5 fw-bold paragraph-font boton-pedido py-2 px-3">
            ...
            <p className="m-0 paragraph-font" onClick={realizarPago}>Pagar</p>
          </button>
